...
- Pattern to flag: renderer/templating code that emits a third-party app's config where no test compares the emitted key+section against that app's source, and nothing reads the value back.
